...
Geoinfosüsteemil QGIS on alati kaks hetkeversioon: stabiilne *Long term release* ja uusimate võimalustega *Latest release*. Praktikumis kasutame praegust stabiilset versiooni 3.22. Väga suuri erinevusi nende versioonide vahel ei ole. Praktikumi saab tehtud ka versioonidega 3.16 ja 3.20. Kel huvi, võib vaadata ka [väljalaske graafikut](https://qgis.org/en/site/getinvolved/development/roadmap.html#release).

QGIS 3.22 saab alla laadida [ametlikult kodulehelt](https://qgis.org/en/site/forusers/download.html). Alla laadimist saab kohe alustada lingilt [QGIS 3.22 download](https://qgis.org/downloads/QGIS-OSGeo4W-3.22.12-1.msi). macOSi jaoks  on see link [macOS QGIS 3.22 download](https://qgis.org/downloads/macos/qgis-macos-ltr.dmg). Kui allalaadimine on lõppenud, ava fail ning installi see nagu iga teine programm. Kasutada vaikimisi valikuid.
...
Praktikumis kasutatavad andmed leiate [Moodle'ist](https://moodle.ut.ee/) ja ka lingilt [praktikumi andmed](https://drive.google.com/file/d/1O1GxuaLd_TztvyLw_8D7IIjPNYVxwq67/view?usp=sharing). Laadige need alla, pakkige lahti (parempoolne klikk ja *Extract here*) ja asetage kausta *andmed*.
...
Kultuurimälestiste andmeid võib vajadusel minu käest küsida. Kirjuta andres.kimber@muinsuskaitseamet.ee. 
